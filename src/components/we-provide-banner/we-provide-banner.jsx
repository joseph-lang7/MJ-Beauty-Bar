const WeProvideBanner = () => {
  return (
    <div className="py-20 w-full flex justify-center">
      <div className="flex flex-col gap-7 items-center max-w-[1200px] px-5">
        <h3 className="text-4xl sm:text-6xl capitalize leading-[50px] sm:leading-[100px] text-center">
...
export default WeProvideBanner;
